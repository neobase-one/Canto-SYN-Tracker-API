...
SYN_DATA = {
    ...
    # },
    "canto": {
        "rpc": os.getenv('CANTO_RPC'),
        "address": "0x555982d2E211745b96736665e19D9308B615F78e",
        "pool": "0x0271984e4cfA2A0f02664baACD551CcFCC9920E8", # proxy?
        "nusd": "0xD8836aF2e565D3Befce7D906Af63ee45a57E8f80",
        ...
        "minichef": "0x93124c923dA389Bc0f13840fB822Ce715ca67ED6",
    }
}
...
# BRIDGE_CONFIG = cast(Web3, SYN_DATA['ethereum']['w3']).eth.contract(
    # Web3.toChecksumAddress('0x5217c83ca75559b1f8a8803824e5b7ac233a12a1'),
...
TOKENS = {
    ...
    #     'a0554607e477cdc9d0ee2a6b087f4b2dc2815c22',  # UST
    ...
    # ],
    'canto': [
        '0x555982d2E211745b96736665e19D9308B615F78e', # SYN
